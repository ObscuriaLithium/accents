package dev.obscuria.accents.fabric.client.renderer;
...
public final class AutoTrinketRenderer implements TrinketRenderer {

    public static final AutoTrinketRenderer SHARED = new AutoTrinketRenderer();

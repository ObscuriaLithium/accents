...
public interface AccentsRecipeSerializers {
    ...
    Deferred<RecipeSerializer<SewingRecipe>> SEWING = register("sewing", () -> new SingleItemRecipe.Serializer<>(SewingRecipe::new));

    private static <T extends Recipe<?>> Deferred<RecipeSerializer<T>> register(String name, Supplier<RecipeSerializer<T>> supplier) {

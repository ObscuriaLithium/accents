...
public final class SewingMenu extends AbstractContainerMenu {
    ...
    @Getter private List<RecipeHolder<SewingRecipe>> recipes;
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (slot.hasItem()) {
            ...
            } else if (this.level.getRecipeManager().getRecipeFor(AccentsRecipes.SEWING.get(), new SingleRecipeInput(stack), this.level).isPresent()) {
    ...
    private void setupRecipeList(Container container, ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            this.recipes = this.level.getRecipeManager().getRecipesFor(AccentsRecipes.SEWING.get(), new SingleRecipeInput(container.getItem(0)), this.level);
        }
    }
    ...
    private void setupResultSlot() {
        if (!this.recipes.isEmpty() && this.isValidRecipeIndex(this.selectedRecipeIndex.get())) {
            ...
            var stack = recipe.value().assemble(new SingleRecipeInput(this.container.getItem(0)), this.level.registryAccess());

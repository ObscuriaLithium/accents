...
public final class AutoVanityRenderer extends GeoArmorRenderer<VanityItem> {

    public AutoVanityRenderer(VanityItem animatable) {
        super(new AutoVanityModel(animatable));
        addRenderLayer(new OverlayLayer(this, animatable.isVanityGlowing()));
    }
    ...
    @Override
    public void applyBoneVisibilityByPart(EquipmentSlot slot, ModelPart part, HumanoidModel<?> model) {
        this.setAllBonesVisible(true);
    }
    ...
    public static final class OverlayLayer extends GeoRenderLayer<VanityItem> {
        ...
        public OverlayLayer(AutoVanityRenderer renderer, boolean glowing) {
            super(renderer);
